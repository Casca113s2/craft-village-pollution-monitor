...
public class AdminController {
	...
	public String localAuthoirityPage(Model model) {
	...
	@ResponseBody
	public HashMap<String, String> createAuthority(@RequestParam Map<String, String>form) throws ClassNotFoundException, SQLException, ParseException {
		...
		int register = userDetailsService.RegisterUsername(username, password, role, name, "", phone, email, dateActive);
		if (register == 1) {
			console.put("key", "1");
