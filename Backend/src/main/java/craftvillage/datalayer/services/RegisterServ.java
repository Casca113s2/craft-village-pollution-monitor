...
public class RegisterServ {
   ...
   * @param urEmail
   * @param urSex
   * @return Number - 1: Success - 2: Fail - 0:
   * @throws ParseException
   */
  public int registeAnUser(String account, String passwordEncode, int roleId, String urFirstname,
      String urLastname, String urPhone, String urEmail, Date activeDate) throws ParseException {
    ...
    if (newUser == null && emailChecker == true) {
      ...
      if (roleUser == null)
        ...
        System.out.println(roleUser.getRoleCode());
