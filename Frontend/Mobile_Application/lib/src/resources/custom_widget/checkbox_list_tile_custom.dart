...
///
/// To show the [CheckboxListTileCustom] as disabled, pass null as the [onChanged]
/// callback.
///
/// {@tool snippet --template=stateful_widget_scaffold}
///
/// ![CheckboxListTileCustom sample](https://flutter.github.io/assets-for-api-docs/assets/material/checkbox_list_tile.png)
///
...
/// {@end-tool}
///
/// ## Semantics in CheckboxListTileCustom
///
/// Since the entirety of the CheckboxListTileCustom is interactive, it should represent
/// itself as a single interactive entity.
///
/// To do so, a CheckboxListTileCustom widget wraps its children with a [MergeSemantics]
/// widget. [MergeSemantics] will attempt to merge its descendant [Semantics]
/// nodes into one node in the semantics tree. Therefore, CheckboxListTileCustom will
/// throw an error if any of its children requires its own [Semantics] node.
///
/// For example, you cannot nest a [RichText] widget as a descendant of
/// CheckboxListTileCustom. [RichText] has an embedded gesture recognizer that
/// requires its own [Semantics] node, which directly conflicts with
/// CheckboxListTileCustom's desire to merge all its descendants' semantic nodes
...
/// {@end-tool}
///
/// ## CheckboxListTileCustom isn't exactly what I want
///
/// If the way CheckboxListTileCustom pads and positions its elements isn't quite
